...
const Content: React.FC<{ open: string | null; close: string | null; pool?: number }> = ({ open, close, pool }) => (
  <div className="relative h-28 bg-gradient-to-br from-[#2e2e47] to-[#3c3c5a] border-[3px] border-dashed border-purple-400 rounded-lg p-4 mb-3 shadow-xl">
...
const Up: React.FC<{ onClick?: () => void; disabled?: boolean }> = ({ onClick, disabled }) => (
  <div className="flex items-center justify-between bg-green-100 px-4 py-3 rounded-xl shadow mb-2">
...
const Down: React.FC<{ onClick?: () => void; disabled?: boolean }> = ({ onClick, disabled }) => (
  <div className="bg-red-100 border border-red-400 rounded-xl px-4 py-3 shadow-sm flex justify-between items-center">
